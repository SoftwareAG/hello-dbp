 ...
 * 
 */
package caf.war.HelloDBOTasks.analyzealertview;
...
@ManagedBean(name = "AnalyzeAlertViewDefaultviewView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "AnalyzeAlertView/default", beanType = BeanType.PAGE)
public class AnalyzeAlertViewDefaultviewView extends com.webmethods.caf.faces.bean.task.BaseTaskDetailsPageBean {
	...
	private static final String[][] TASKDISPLAYPROVIDER_PROPERTY_BINDINGS = new String[][] {
		{"#{TaskDisplayProvider.taskID}", "#{AnalyzeAlertView.taskID}"},
	};
	...
	public String cancelView() {
		try {
			...
			String url = getAnalyzeAlertView().getFinishUrl();
	...
	public String completeTask() {
		try {
			if( !getAnalyzeAlert().isUpdateable() ){
	...
	public String assignToPrincipals() {
		try {
			...
			TaskContentProvider tp = getAnalyzeAlert();
	...
	private static final String[][] INITIALIZE_PROPERTY_BINDINGS = new String[][] {
		{"#{AnalyzeAlert.reset}", null}
	};
	private transient caf.war.HelloDBOTasks.analyzealertview.AnalyzeAlertView analyzeAlertView = null;
	...
	private static final String[][] ANALYZEALERT_PROPERTY_BINDINGS = new String[][] {
		{"#{AnalyzeAlert.taskID}", "#{AnalyzeAlertView.taskID}"},
		{"#{AnalyzeAlert.autoAccept}", "false"},
		{"#{AnalyzeAlert.adhocRouting}", "false"},
	};
	...
	public caf.war.HelloDBOTasks.analyzealertview.AnalyzeAlertView getAnalyzeAlertView()  {
		if (analyzeAlertView == null) {
		    analyzeAlertView = (caf.war.HelloDBOTasks.analyzealertview.AnalyzeAlertView)resolveExpression("#{AnalyzeAlertView}");
		}
		return analyzeAlertView;
	}
