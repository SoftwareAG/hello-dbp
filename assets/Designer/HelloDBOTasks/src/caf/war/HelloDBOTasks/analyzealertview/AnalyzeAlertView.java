...
@ManagedBean(name = "AnalyzeAlertView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "AnalyzeAlertView", beanType = BeanType.PORTLET)
public class AnalyzeAlertView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
